...
const BulletCursorOverlay = ({
  ...
  //=========== EXPERIMENT WITH STATIC CURSOR POSITION============
  // 1) when overlay in top-left of Tree Node
  // const translateX = treenode.left - overlay.left // should be 0
  // const translateX = 367.5 - 367.5
  // const translateY = treenode.top - overlay.top // should be 0
  // const translateY = 89.515625 - 89.515625

  // 2) when the overlay in center of Bullet
  const bulletLeft = 346.265625
  const treeNodeLeft = 367.5
  const translateX = bulletLeft - treeNodeLeft
  const bulletTop = 96.453125
  const treeNodeTop = 89.515625
  const translateY = bulletTop - treeNodeTop
